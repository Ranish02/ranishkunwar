        ...
        <div className="w-screen h-screen text-white md:pt-[50px] px-4">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="flex justify-center text-center px-2 items-center">
              <div className="xl:ml-16">
                ...
                <div className="p-4 text-sm md:text-base">
                  Here are a few notable framework that I been using to create
                  apps.
                  <br />
                </div>
              </div>
            ...
            <div className="flex justify-center items-center">
              <div>
                <img
                  src="https://cdn.discordapp.com/attachments/979623779477123122/1053339351079211019/IMG-20220411-WA0032.jpg"
                  alt=""
              ...
              <div>
                <div className=" pt-1 flex justify-end ">
                  ...
                  <button
                    className={
                      view === "slider"
                        ? "px-2 py-2 mx-1 bg-[#e5c5ff]"
                        : "px-2 pt-2 pb-1 mx-1 bg-[#D09CFA]"
                    }
